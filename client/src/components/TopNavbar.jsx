...
import { toggleSearch, toggleCart } from './data/ActionCreators';
...
export const TopNavbar = connect(
  ...
  class TopNavbar extends Component {
    ...
    toggleSearch = () => this.props.toggleSearch(!this.props.searchOpen);

    toggleCart = () => this.props.toggleCart(!this.props.cartOpen);
